...
const diagrams: Diagram[] = [
  ...
  },
  {
    ...
    name: "企业级 E-SSD",
    shortName: "E-SSD",
    subtitle: "NAND、控制器、PCIe PHY、DDR 与 LPDDR 多路电源轨",
    family: "服务器电源",
    src: "diagrams/enterprise-ssd-power-rail.svg",
    viewBox: "0 0 960 540",
    hotspots: [
      { id: "essd-nand-vdd", label: "NAND VDD", category: "电源管理", description: "为 NAND 提供 2.5V、6–8A 核心电源轨。", x: 421, y: 89, width: 148, height: 42, products: [southchipProduct("SC812A2", "NAND VDD 电源方案。") ] },
      { id: "essd-nand-vpp", label: "NAND VPP", category: "电源管理", description: "为 NAND 提供 12V 编程电源轨。", x: 421, y: 138, width: 148, height: 42, products: [southchipProduct("SC8723", "NAND VPP 电源方案。") ] },
      { id: "essd-nand-vccq", label: "NAND VCCQ", category: "电源管理", description: "为 NAND I/O 提供 1.2V 电源轨。", x: 421, y: 187, width: 148, height: 42, products: [southchipProduct("SC81360", "NAND VCCQ 电源方案。") ] },
      { id: "essd-core-power", label: "控制器核心电源", category: "电源管理", description: "为 E-SSD 控制器核心提供大电流低压电源。", x: 421, y: 236, width: 148, height: 42, products: [southchipProduct("SC812B0", "控制器核心电源方案。") ] },
      { id: "essd-pcie-power", label: "PCIe PHY 电源", category: "电源管理", description: "为 PCIe PHY 提供 VDDH 与 VDDA 电源轨。", x: 421, y: 285, width: 148, height: 91, products: [southchipProduct("SC81220", "PCIe VDDH / VDDA 电源方案。") ] },
      { id: "essd-ddr-vddq", label: "DDR VDD / VDDQ", category: "电源管理", description: "为 DDR 提供 VDD 与 VDDQ 电源轨。", x: 421, y: 383, width: 148, height: 42, products: [southchipProduct("SC81260", "DDR VDD / VDDQ 电源方案。") ] },
      { id: "essd-ddr-vpp", label: "DDR VPP", category: "电源管理", description: "为 DDR 提供 VPP 电源轨。", x: 421, y: 432, width: 148, height: 42, products: [southchipProduct("SC81220", "DDR VPP 电源方案。") ] },
      { id: "essd-raid-ups", label: "RAID UPS 超级电容充电", category: "充电管理", description: "为 RAID UPS 超级电容提供充电管理。", x: 87, y: 276, width: 104, height: 42, products: [southchipProduct("SC8984", "RAID UPS 超级电容充电方案。") ] },
      { id: "essd-charge-pump", label: "两级电源电荷泵", category: "电源管理", description: "面向两级电源架构的电荷泵前级。", x: 54, y: 432, width: 139, height: 42, products: [southchipProduct("SC8508", "两级电源架构的电荷泵变换方案。"), southchipProduct("SC8525", "两级电源架构的电荷泵变换方案。") ] },
      { id: "essd-plp-efuse", label: "PLP + eFuse", category: "保护与电源路径", description: "用于掉电保护与输入电源路径控制。", x: 221, y: 91, width: 102, height: 40 },
    ],
    views: [
      {
        id: "current-power-rail",
        label: "E-SSD 电源轨",
        description: "企业级 SSD 的 NAND、控制器、PCIe PHY 与 DDR 电源架构。",
        src: "diagrams/enterprise-ssd-power-rail.svg",
        hotspots: [
          { id: "essd-nand-vdd", label: "NAND VDD", category: "电源管理", description: "为 NAND 提供 2.5V、6–8A 核心电源轨。", x: 421, y: 89, width: 148, height: 42, products: [southchipProduct("SC812A2", "NAND VDD 电源方案。") ] },
          { id: "essd-nand-vpp", label: "NAND VPP", category: "电源管理", description: "为 NAND 提供 12V 编程电源轨。", x: 421, y: 138, width: 148, height: 42, products: [southchipProduct("SC8723", "NAND VPP 电源方案。") ] },
      ...
      },
      {
        id: "lpddr-power-rail",
        label: "LPDDR 电源轨",
        description: "企业级 SSD 的 LPDDR PMIC 与两级电源架构。",
        src: "diagrams/enterprise-ssd-lpddr.svg",
        hotspots: [
          { id: "essd-lpddr-pmic", label: "LPDDR PMIC", category: "电源管理", description: "为 LPDDR4/5 提供 1.1–1.2V、5–6A 电源。", x: 399, y: 181, width: 165, height: 70, products: [southchipProduct("SC6301", "LPDDR4/5 PMIC 方案。"), southchipProduct("SC6302", "LPDDR4/5 PMIC 方案。"), southchipProduct("SC6303", "LPDDR4/5 PMIC 方案。") ] },
          { id: "essd-lpddr-charge-pump", label: "两级电源电荷泵", category: "电源管理", description: "为两级 LPDDR 电源架构提供电荷泵前级。", x: 120, y: 330, width: 190, height: 62, products: [southchipProduct("SC8508", "两级电源架构的电荷泵变换方案。"), southchipProduct("SC8525", "两级电源架构的电荷泵变换方案。") ] },
          { id: "essd-lpddr-pmic-dcdc", label: "PMIC / DCDC", category: "电源管理", description: "两级 LPDDR 电源架构的后级 PMIC / DCDC，产品待规划。", x: 381, y: 330, width: 154, height: 62 },
        ],
      },
    ],
  },
